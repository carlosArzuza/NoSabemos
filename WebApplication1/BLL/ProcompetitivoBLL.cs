            ...
            using (var contex = new ModelContex())
            {
                ...
                if (result != null)
                {
                    foreach (var item in result)
                    {
                        ...
                        proceso.PRESUPUESTO = item.PRESUPUESTO;
                        proceso.ORIGEN = item.ORIGEN;
                        proceso.CATEGORIA = item.CATEGORIA;
                        proceso.FAMILIA = item.FAMILIA;
                        proceso.TIPO = item.TIPO;
                        proceso.DESC_GENERAL = item.DESC_GENERAL;
