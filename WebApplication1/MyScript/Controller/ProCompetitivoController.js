  ...
  , $scope.maxSize = 6;
    ...
    function loadRecords() {
        ...
        promiseGet.then(function (pl) {
            ...
            angular.forEach($scope.Procesos, function (item, dato) {
                ...
                var fecha1 = new Date();
                var fecha2 = new Date(item.FECHA_INIC_SERVICE);
    ...
    $scope.remove = function () {
        ...
        swal({
          ...
          function (isConfirm) {
              if (isConfirm) {
                  var result = ProcompetitivoServices.delete($scope.Proceso.ID_COMPETITIVO);
                  result.then(function () {
                      loadRecords();
                      $scope.visibilidadOff();
                  },
                  ...
                  swal("Mensaje de Notificacion", "El procesos competitivo fue anulado exitosamente.", "success");
              } else {
                  swal("Mensaje de Notificacion", "La anulacion del proceso competitivo no fue confirmada.", "error");
              }
          });
    ...
    $scope.Editar = function () {
        $scope.Proceso = this.Proceso;
        $scope.Proyec = this.Proyec;
        $scope.Proyec.PROYECTO = $scope.Proceso.PROYECTO;
        localStorage.setItem('PROYECTO', $scope.Proyec.PROYEC_ID)
        $scope.Mostrar();
    }
});